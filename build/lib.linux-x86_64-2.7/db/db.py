...
class db(object):
    ...
    def populate_db(self, namedict):
        ...
        self.cur.executemany(
            ...
            (model_struct, loss_function, wd_layers, wd_penalty, optimizer, lr, dataset)
            VALUES
            (%(model_struct)s, %(loss_function)s, %(wd_layers)s, %(wd_penalty)s, %(optimizer)s, %(lr)s, %(dataset)s)
            """,
            namedict)
